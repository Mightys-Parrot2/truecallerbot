    ...
    try:
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🗯 Update Channel", url="https://t.me/PEGASUSxXD"),
                        InlineKeyboardButton("💬 Support", url="https://t.me/PEGASUSxXD")
                    ]
                ]
            )
...
||🔥 Powered By @PEGASUSxXD ©️ | @TheTruecaller_Bot 🤖||**""", reply_markup=keyboard)
        elif m.chat.type == enums.ChatType.GROUP or enums.ChatType.SUPERGROUP:
            keyboar = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/PEGASUSxBOT?start=start")
                    ]
                ]
            )
            add_group(m.chat.id)
        ...
        await m.reply_text("**🚧Access Denied!🚧\n\nPlease Join @{} to use me.If you joined click check again button to confirm.**".format("PEGASUS"), reply_markup=key)
    except Exception as e:
        print(e)
...
🪩To see how it works just send /help command.
🎡 Other Countries will add soon.
||🔥 Powered By @PEGASUSxXD ©️ | @PEGASUSxBOT 🤖||**""", reply_markup=keyboard) 
